...
var H = (r, e) => () => (e || r((e = { exports: {} }).exports, e), e.exports),
  ...
  J = (r, e, n, t) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let a of tr(e))
        !ur.call(r, a) && a !== n && z(r, a, { get: () => e[a], enumerable: !(t = ar(e, a)) || t.enumerable });
    return r;
  };
var K = (r, e, n) => (
    (n = r != null ? nr(sr(r)) : {}), J(e || !r || !r.__esModule ? z(n, 'default', { value: r, enumerable: !0 }) : n, r)
  ),
            ...
            if (w.ok) s.push(`<testcase name="${T}" classname="${t}" />`);
              ...
              let b =
                ...
                Object.entries(p.values)
                  .map(([$, O]) => `${$} value: ${O}`)
                  .join(', ');
              s.push(`<testcase name="${T}" classname="${t}"><failure message="${S(b)}" /></testcase>`);
            }
          });
      }),
      `<?xml version="1.0"?>
...
var U = H((N) => {
  var _ = function (r, e) {
      for (var n in r) if (Object.prototype.hasOwnProperty.call(r, n) && e(n, r[n])) break;
    },
    ...
    A = '\u2713',
    C = '\u2717',
    cr = { indent: ' ', enableColors: !0, summaryTimeUnit: null, summaryTrendStats: null };
  function m(r) {
...
`
    ...
    for (let a = 0; a < e.groups.length; a++) Array.prototype.push.apply(t, k(r, e.groups[a], n));
    return t;
  }
  function Q(r) {
    var e = r.indexOf('{');
  ...
  var V = { s: { unit: 's', coef: 0.001 }, ms: { unit: 'ms', coef: 1 }, us: { unit: '\xB5s', coef: 1e3 } };
  function I(r, e) {
  ...
  function yr(r) {
    ...
    var e = D((r % 6e4) / 1e3, r > 6e4 ? 0 : 2) + 's',
      n = Math.trunc(r / 6e4);
    return n < 1 || ((e = (n % 60) + 'm' + e), (n = Math.trunc(n / 60)), n < 1) ? e : n + 'h' + e;
  }
  function mr(r, e) {
    return e !== '' && Object.prototype.hasOwnProperty.call(V, e) ? (r * V[e].coef).toFixed(2) + V[e].unit : yr(r);
  }
  function d(r, e, n) {
    if (e.type == 'rate') return (Math.trunc(r * 100 * 100) / 100).toFixed(2) + '%';
    switch (e.contains) {
      case 'data':
        return gr(r);
      case 'time':
  ...
  function xr(r, e) {
    switch (r.type) {
      ...
      case 'gauge':
        return [d(r.values.value, r, e), 'min=' + d(r.values.min, r, e), 'max=' + d(r.values.max, r, e)];
      case 'rate':
        return [d(r.values.rate, r, e), A + ' ' + r.values.passes, C + ' ' + r.values.fails];
      default:
        return ['[no data]'];
    }
  }
  function dr(r, e, n) {
    ...
    var er = function (u) {
      if (Object.prototype.hasOwnProperty.call(b, u)) {
        ...
        for (let i = 0; i < l.length; i++)
          y[i] = r.summaryTrendStats[i] + '=' + n(l[i], c.cyan) + ' '.repeat(O[i] - m(l[i]));
        return y.join(' ');
      }
      var x = p[u],
      ...
      if (f.length == 1) v = v + ' ' + n(f[0], c.cyan, c.faint);
        ...
        for (let i = 0; i < f.length; i++) h[i] = n(f[i], c.cyan, c.faint) + ' '.repeat(T[i] - m(f[i]));
        v = v + ' ' + h.join(' ');
      }
      return v;
    };
    for (var B of s) {
      ...
      var G = R(B),
        F = Q(B);
      (F = F + n('.'.repeat(M - m(F) - m(G) + 3) + ':', c.faint)), a.push(t + G + L(P) + ' ' + F + ' ' + er(B));
    }
    return a;
  }
  function Mr(r, e) {
    ...
    return (
      n.enableColors &&
        (a = function (s, M) {
          for (var p = '\x1B[' + M, g = 2; g < arguments.length; g++) p += ';' + arguments[g];
          return p + 'm' + s + '\x1B[0m';
        }),
...
var Tr = {};
ir(Tr, { humanizeValue: () => E.humanizeValue, jUnit: () => rr.jUnit, textSummary: () => E.textSummary });
